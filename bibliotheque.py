...
cur.execute("INSERT INTO livres (titre, auteur, disponible) VALUES (?, ?, ?)", ('Le Rouge et le Noir', 'Stendhal', 1))
...
cur.execute("INSERT INTO livres (titre, auteur, disponible) VALUES (?, ?, ?)", ("Jacques La Fatalis", 'Diderot', 1))
